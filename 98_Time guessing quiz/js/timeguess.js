...
stop.addEventListener("click",
  function() {
    ...
    if(timer.textContent.substring(0,5) === "00:10"){
      ...
      const cat = document.getElementsByTagName("body");
      cat[0].style.backgroundImage="url('img/cat.gif')";
      cat[0].style.backgroundColor="rgba(0,0,0,0)";
    }else{soundControl("start","sound/stop1.mp3");}
    soundEndflag="1";
    // タイマーを"停止中"状態とする
...
reset.addEventListener("click",
  function() {
    ...
    stopTime = 0;
    const cat = document.getElementsByTagName("body");
    cat[0].style.backgroundImage="";
    cat[0].style.backgroundColor="rgba(233,168,227,0.6)";
  }
);
